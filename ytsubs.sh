...
menu_
function data_ () {
	        ez1=$(curl --silent "https://api.subcount.app/channel/list/$users" -H 'Accept: application/json, text/plain, */*' -H 'Referer: https://subscribercounter.com/' -H 'Origin: https://subscribercounter.com' -H 'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36' -H 'Authorization: Basic eXRzYzpiZWk2emVleGFlMGFlaGFlMkhlZXcyZWVt' --compressed|
                grep -oP '(?<="success":)[^,]*')
